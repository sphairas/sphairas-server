...
@Table(name = "TERMTEXT_TARGETASSESSMENT_DOCUMENT_ENTRIES2",
        ...
        indexes = {
            @Index(columnList = "TERM_AUTHORITY, TERM_ID", name = "INDEX_TERMTEXT_TARGETASSESSMENT_DOCUMENT_ENTRIES2_TERM"),
            @Index(columnList = "STUDENT_AUTHORITY, STUDENT_ID", name="INDEX_TERMTEXT_TARGETASSESSMENT_DOCUMENT_ENTRIES2_STUDENT"),
            @Index(columnList = "MARKER_CONVENTION, MARKER_SUBSET, MARKER_ID", name="INDEX_TERMTEXT_TARGETASSESSMENT_DOCUMENT_ENTRIES2_MARKER")})
